...
import 'package:flutter_app/modules/news_app/sports/SportScreen.dart';
import 'package:flutter_app/modules/shop_app/settings/SettingsScreen.dart';
  ...
  void getBusinessData()
  {
    ...
    DioHelper.getData(
      ...
      query:
      {
        'country':'eg',
        'category':'business',
        'apiKey':'2d5123fae8b04bfa95ac7568607692fc',
      },
    ).then((value)
    {
